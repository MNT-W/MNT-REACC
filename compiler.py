...
def compile(debug_mode):
    ...
    with open('MNT.key', 'wb') as save_key: save_key.write(os.urandom(1024*1024))
    ...
    with open('source_prepared.py', 'w', encoding='utf-8') as edit_source_code:
        for line_number, line in enumerate(source_code):
            ...
            elif line.startswith('secret_key'): edit_source_code.write('secret_key = \'' + get_file_hash('MNT.key') + '\'\n')
